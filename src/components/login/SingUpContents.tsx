        ...
        <div className="signup-form">
          <div className="signup-item">
            ...
            <div className="signup-item-data-wrap">
              ...
              <div className="signup-btn">
                <button className="btn-form black-outline block">
                  중복 확인
                </button>
              </div>
          ...
          <div className="signup-item">
            ...
            <div className="signup-item-data-wrap">
              <div className="input-icon-frame ">
                ...
                <button
                  type="button"
                  className="input-icon-btn del mr10"
                ></button>
          ...
          <div className="signup-item">
            ...
            <div className="signup-item-data-wrap">
              ...
              <div className="signup-warning right">
                입력 하신 비밀번호가 일치 합니다.
              </div>
            </div>
          </div>
          ...
          <div className="signup-item">
            ...
            <div className="signup-item-data-wrap">
              <div className="input-icon-frame">
                <input type="text" placeholder="-제외하소 입력" />
              </div>
              <div className="signup-btn">
                <button className="btn-form black-outline block">
                  중복 확인
          ...
          <div className="signup-item">
            ...
            <div className="signup-item-data-wrap">
              <div className="signup-flx-wrap">
                <div className="signup-btn">
                  <button className="btn-form grey-outline block active">
                    여자
                  </button>
                </div>
                <div className="signup-btn">
            ...
            <div className="service-check-wrap">
              <div className="service-check-header">
                <div className="check-form-box">
                  ...
                  <label htmlFor="service">서비스 이용 약관 동의</label>
                </div>
                <div className="service-arr-btn">
                  <button type="button" className="arr-btn"></button>
                </div>
              </div>
              <div className="service-check-content"></div>
            </div>
          </div>
        </div>
        <LoginFooter />
